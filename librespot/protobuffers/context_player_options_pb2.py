...
_CONTEXTPLAYEROPTIONS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='shuffling_context', full_name='spotify.player.proto.ContextPlayerOptions.shuffling_context', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='repeating_context', full_name='spotify.player.proto.ContextPlayerOptions.repeating_context', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='repeating_track', full_name='spotify.player.proto.ContextPlayerOptions.repeating_track', index=2,
...
_CONTEXTPLAYEROPTIONOVERRIDES = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='shuffling_context', full_name='spotify.player.proto.ContextPlayerOptionOverrides.shuffling_context', index=0,
      number=1, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='repeating_context', full_name='spotify.player.proto.ContextPlayerOptionOverrides.repeating_context', index=1,
      number=2, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='repeating_track', full_name='spotify.player.proto.ContextPlayerOptionOverrides.repeating_track', index=2,
      number=3, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
DESCRIPTOR.message_types_by_name['ContextPlayerOptionOverrides'] = _CONTEXTPLAYEROPTIONOVERRIDES
...
ContextPlayerOptionOverrides = _reflection.GeneratedProtocolMessageType('ContextPlayerOptionOverrides', (_message.Message,), {
