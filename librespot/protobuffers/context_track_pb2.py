...
_CONTEXTTRACK_METADATAENTRY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='spotify.player.proto.ContextTrack.MetadataEntry.key', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='value', full_name='spotify.player.proto.ContextTrack.MetadataEntry.value', index=1,
...
_CONTEXTTRACK = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='uri', full_name='spotify.player.proto.ContextTrack.uri', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='uid', full_name='spotify.player.proto.ContextTrack.uid', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='gid', full_name='spotify.player.proto.ContextTrack.gid', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='metadata', full_name='spotify.player.proto.ContextTrack.metadata', index=3,
  ...
  nested_types=[_CONTEXTTRACK_METADATAENTRY, ],
  enum_types=[
  ],
...
ContextTrack = _reflection.GeneratedProtocolMessageType('ContextTrack', (_message.Message,), {
