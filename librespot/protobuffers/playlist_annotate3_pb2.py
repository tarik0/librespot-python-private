...
_RENDERFEATURES = _descriptor.EnumDescriptor(
  ...
  values=[
    _descriptor.EnumValueDescriptor(
      name='NORMAL_FEATURES', index=0, number=1,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='EXTENDED_FEATURES', index=1, number=2,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
_ABUSEREPORTSTATE = _descriptor.EnumDescriptor(
  ...
  values=[
    _descriptor.EnumValueDescriptor(
      ...
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='TAKEN_DOWN', index=1, number=1,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
_TAKEDOWNREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='abuse_report_state', full_name='spotify_playlist_annotate3.proto.TakedownRequest.abuse_report_state', index=0,
...
_ANNOTATEREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='description', full_name='spotify_playlist_annotate3.proto.AnnotateRequest.description', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='image_uri', full_name='spotify_playlist_annotate3.proto.AnnotateRequest.image_uri', index=1,
...
_TRANSCODEDPICTURE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='target_name', full_name='spotify_playlist_annotate3.proto.TranscodedPicture.target_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='uri', full_name='spotify_playlist_annotate3.proto.TranscodedPicture.uri', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_PLAYLISTANNOTATION = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='description', full_name='spotify_playlist_annotate3.proto.PlaylistAnnotation.description', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='picture', full_name='spotify_playlist_annotate3.proto.PlaylistAnnotation.picture', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='deprecated_render_features', full_name='spotify_playlist_annotate3.proto.PlaylistAnnotation.deprecated_render_features', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='transcoded_picture', full_name='spotify_playlist_annotate3.proto.PlaylistAnnotation.transcoded_picture', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='is_abuse_reporting_enabled', full_name='spotify_playlist_annotate3.proto.PlaylistAnnotation.is_abuse_reporting_enabled', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='abuse_report_state', full_name='spotify_playlist_annotate3.proto.PlaylistAnnotation.abuse_report_state', index=5,
...
_PLAYLISTANNOTATION.fields_by_name['deprecated_render_features'].enum_type = _RENDERFEATURES
_PLAYLISTANNOTATION.fields_by_name['transcoded_picture'].message_type = _TRANSCODEDPICTURE
...
TakedownRequest = _reflection.GeneratedProtocolMessageType('TakedownRequest', (_message.Message,), {
...
TranscodedPicture = _reflection.GeneratedProtocolMessageType('TranscodedPicture', (_message.Message,), {
...
PlaylistAnnotation = _reflection.GeneratedProtocolMessageType('PlaylistAnnotation', (_message.Message,), {
