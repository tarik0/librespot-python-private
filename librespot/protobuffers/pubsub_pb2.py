...
_SUBSCRIPTION = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='uri', full_name='spotify.Subscription.uri', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='expiry', full_name='spotify.Subscription.expiry', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='status_code', full_name='spotify.Subscription.status_code', index=2,
