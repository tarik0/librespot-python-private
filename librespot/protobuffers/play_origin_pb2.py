...
_PLAYORIGIN = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='feature_identifier', full_name='spotify.player.proto.PlayOrigin.feature_identifier', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='feature_version', full_name='spotify.player.proto.PlayOrigin.feature_version', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='view_uri', full_name='spotify.player.proto.PlayOrigin.view_uri', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='external_referrer', full_name='spotify.player.proto.PlayOrigin.external_referrer', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='referrer_identifier', full_name='spotify.player.proto.PlayOrigin.referrer_identifier', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='device_identifier', full_name='spotify.player.proto.PlayOrigin.device_identifier', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='feature_classes', full_name='spotify.player.proto.PlayOrigin.feature_classes', index=6,
