...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[context__player__options__pb2.DESCRIPTOR,playback__pb2.DESCRIPTOR,session__pb2.DESCRIPTOR,queue__pb2.DESCRIPTOR,])
...
_TRANSFERSTATE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='options', full_name='spotify.player.proto.transfer.TransferState.options', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='playback', full_name='spotify.player.proto.transfer.TransferState.playback', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='current_session', full_name='spotify.player.proto.transfer.TransferState.current_session', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='queue', full_name='spotify.player.proto.transfer.TransferState.queue', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='creation_timestamp', full_name='spotify.player.proto.transfer.TransferState.creation_timestamp', index=4,
...
_TRANSFERSTATE.fields_by_name['options'].message_type = context__player__options__pb2._CONTEXTPLAYEROPTIONS
...
TransferState = _reflection.GeneratedProtocolMessageType('TransferState', (_message.Message,), {
