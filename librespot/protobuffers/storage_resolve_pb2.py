...
_STORAGERESOLVERESPONSE_RESULT = _descriptor.EnumDescriptor(
  ...
  values=[
    _descriptor.EnumValueDescriptor(
      name='CDN', index=0, number=0,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='STORAGE', index=1, number=1,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='RESTRICTED', index=2, number=3,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
_STORAGERESOLVERESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='result', full_name='spotify.download.proto.StorageResolveResponse.result', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='cdnurl', full_name='spotify.download.proto.StorageResolveResponse.cdnurl', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='fileid', full_name='spotify.download.proto.StorageResolveResponse.fileid', index=2,
...
_STORAGERESOLVERESPONSE.fields_by_name['result'].enum_type = _STORAGERESOLVERESPONSE_RESULT
...
StorageResolveResponse = _reflection.GeneratedProtocolMessageType('StorageResolveResponse', (_message.Message,), {
