...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[context__pb2.DESCRIPTOR,context__player__options__pb2.DESCRIPTOR,play__origin__pb2.DESCRIPTOR,])
...
_SESSION = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='play_origin', full_name='spotify.player.proto.transfer.Session.play_origin', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='context', full_name='spotify.player.proto.transfer.Session.context', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='current_uid', full_name='spotify.player.proto.transfer.Session.current_uid', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='option_overrides', full_name='spotify.player.proto.transfer.Session.option_overrides', index=3,
...
_SESSION.fields_by_name['option_overrides'].message_type = context__player__options__pb2._CONTEXTPLAYEROPTIONOVERRIDES
