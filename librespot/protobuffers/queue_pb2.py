...
import librespot.protobufferscontext_track_pb2 as context__track__pb2
...
_QUEUE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='tracks', full_name='spotify.player.proto.transfer.Queue.tracks', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='is_playing_queue', full_name='spotify.player.proto.transfer.Queue.is_playing_queue', index=1,
