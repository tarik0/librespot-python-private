...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[context__page__pb2.DESCRIPTOR,restrictions__pb2.DESCRIPTOR,])
...
_CONTEXT_METADATAENTRY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='spotify.player.proto.Context.MetadataEntry.key', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='value', full_name='spotify.player.proto.Context.MetadataEntry.value', index=1,
...
_CONTEXT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='uri', full_name='spotify.player.proto.Context.uri', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='url', full_name='spotify.player.proto.Context.url', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='metadata', full_name='spotify.player.proto.Context.metadata', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='restrictions', full_name='spotify.player.proto.Context.restrictions', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='pages', full_name='spotify.player.proto.Context.pages', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='loading', full_name='spotify.player.proto.Context.loading', index=5,
  ...
  nested_types=[_CONTEXT_METADATAENTRY, ],
  enum_types=[
  ],
